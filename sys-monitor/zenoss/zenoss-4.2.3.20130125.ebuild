...
SRC_URI="http://www.github.com/${GITHUB_USER}/${GITHUB_REPO}/archive/${GITHUB_TAG}.tar.gz -> zenoss-build-${GITHUB_TAG}.tar.gz http://www.funtoo.org/distfiles/zenoss/$ZENOSS_A http://www.funtoo.org/distfiles/zenoss/$ZENOSS_PIP_A"
